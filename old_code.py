...
def rxn(t, y, args):
    ...
    Ea1, Ba1, Fa1, Fa1_in, Ea2, Ba2, Fa2, Fa2_in, Ed1, Bd1, Fd1, Fd1_in, Fd2_in, Ed2, Bd2, Fd2, Fd2_in, Ek1, Bk1, Fk1, Fk1_in, Ek2, Bk2, Fk2, Fk2_in=args
...
def cross_entropy_loss(params, t_points, y_data, initial_conditions, volume=1.0):
    ...
    solution = diffeqsolve(term, Tsit5(), t0=t_points[0], t1=t_points[-1], dt0=0.01, y0=initial_conditions, args=params, saveat=SaveAt(ts=t_points), max_steps=10000)
...
if __name__ == "__main__":
    #training set
    #given inputs input values, and give labels as occupation of W, W*
